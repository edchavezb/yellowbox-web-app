...
const defaultBoxes: UserBox[] = [
  {
    ...
    subSections: [
      {type: "artists", name: "Da Worst", items: []}
    ],
    notes: []
  },
  {
    ...
    subSections : [
      {type: "artists", name: "Da Best", items: []},
      {type: "artists", name: "Super hits", items: []},
    ],
    notes: []
  }
];
